...
function Card( { id, price, title, image, category, data} ) {
    ...
    function renderIcon(id){
        ...
        if (isInCart) {
            ...
            return (
                <button className='absolute top-0 right-0 flex justify-center items-center bg-gray-400/20 w-6 h-6 rounded-full m-2 p-1' onClick={(e) => {addProductsToCart(e, data);}}>
    ...
    return (
        <div onClick={() => showProduct(data)} className='bg-white cursor-pointer w-56 h-60 rounded-lg shadow-lg'>
